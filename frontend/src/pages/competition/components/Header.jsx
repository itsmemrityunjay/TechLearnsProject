...
import { FaTrophy, FaPlus, FaArrowRight } from 'react-icons/fa';
        ...
        <section className="relative bg-gradient-to-br from-[#013954] to-[#01273b] py-16 md:py-20 overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        >
                            <span className="inline-block px-4 py-1 bg-[#f99e1c]/10 text-[#f99e1c] rounded-full text-sm font-medium mb-4">
                                TechLearns Competitions
                            </span>
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-4">
                                Showcase Your Skills, <br className="hidden md:block" />
                                <span className="text-[#f99e1c]">Win Recognition</span>
                            </h1>
                            <p className="text-white/80 text-base md:text-lg max-w-2xl mx-auto lg:mx-0">
                                Join our tech competitions to challenge yourself, connect with like-minded innovators,
                                and get recognized for your exceptional abilities.
                            </p>
                        </motion.div>
                        ...
                        >
                            <Link to="/competitions/browse" className="px-6 py-3 bg-[#f99e1c] hover:bg-[#f99e1c]/90 text-white font-medium rounded-lg shadow-lg shadow-[#f99e1c]/20 transition-all duration-300 flex items-center justify-center gap-2 group">
                                Browse Competitions
                                <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
                            </Link>

                            <Link to="/competitions-host" className="px-6 py-3 bg-transparent hover:bg-white/10 text-white border-2 border-white/30 font-medium rounded-lg transition-colors duration-300 flex items-center justify-center gap-2">
                                <FaPlus size={14} />
                                Host Competition
                            </Link>
                        </motion.div>
                        ...
                        >
                            {[
                                { value: "50+", label: "Active Competitions" },
                    ...
                    {/* Right content - Trophy illustration */}
                    <motion.div
                            ...
                            <div className="bg-gradient-to-br from-[#f99e1c]/20 to-[#f99e1c]/5 p-6 rounded-2xl shadow-xl relative overflow-hidden">
                                ...
                                <div className="absolute top-5 left-5 bg-white/90 backdrop-blur-sm p-3 rounded-lg shadow-lg transform -rotate-6">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[#013954] font-medium text-sm">AI Challenge</span>
                                    </div>
                                </div>
                                ...
                                <div className="absolute bottom-10 right-5 bg-white/90 backdrop-blur-sm p-3 rounded-lg shadow-lg transform rotate-6">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[#013954] font-medium text-sm">Web Hackathon</span>
                                    </div>
                                </div>
                            </div>
