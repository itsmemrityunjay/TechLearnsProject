    ...
    useEffect(() => {
        const fetchCompetitions = async () => {
            try {
                ...
                setCompetitions(externalCompetitions);
            } catch (error) {
                console.error('Error fetching external competitions:', error);
                setError('Failed to load external competitions. Please try again later.');
            } finally {
                setLoading(false);
            }
        };
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="mb-10 text-center">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-gray-600">
                        Explore external competitions from our partners and other organizations to expand your horizons.
                    </p>
                </div>
                ...
                {!loading && !error && competitions.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-xl font-semibold text-gray-500 mb-1">No external competitions available</h3>
                                    ...
                                    <div className="p-5">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <a
                                                ...
                                                className="bg-[#f99e1c] hover:bg-[#f99e1c]/90 text-white px-4 py-1 rounded-md text-sm font-medium shadow-sm transition-colors duration-200 flex items-center"
                                            >
                                                Join Competition <FaExternalLinkAlt className="ml-1" size={12} />
                                            </a>
                                        </div>
                                    </div>
                                </motion.div>
